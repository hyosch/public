...
class MemberServiceTest {
    ...
    @Autowired
    MemberServiceCriteria memberServiceCriteria;

    @Test
    void getAllMember() {
        List<Member> memberList = memberServiceCriteria.getAllMember();
    ...
    @Test
    void getTeacher() {
        Member member = memberServiceCriteria.getTeacher("1");
    ...
    @Test
    void getStudent() {
        Member member = memberServiceCriteria.getStudent("4");
